...
public class ParamValidator {
    public void validate(Goal goal, Map<Param, List<String>> params) {
        if (goal == Goal.SYNC || goal == Goal.DEL) {
            ...
            validateParams(params, Lists.newArrayList(Param.ENV_PATH, Param.RESOURCE_ID, Param.INSTANCE_INDEX, Param.SSH_TUNNEL_RESOURCE_ID, Param.SSH_USER), Lists.newArrayList(Param.RESOURCE_ID));
        } else {
