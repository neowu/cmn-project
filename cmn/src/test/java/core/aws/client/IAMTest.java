...
public class IAMTest {
    ...
    public void assumeRolePolicy() {
        IAM iam = new IAM(new DefaultAWSCredentialsProviderChain(), Region.getRegion(Regions.US_EAST_1));
    ...
    public void assumeRolePolicyWithChinaRegion() {
        IAM iam = new IAM(new DefaultAWSCredentialsProviderChain(), Region.getRegion(Regions.CN_NORTH_1));
        String document = iam.assumeRolePolicyDocument();
